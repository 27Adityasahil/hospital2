  ...
  const centers = [
    {
      ...
      description: 'Advanced heart care with cutting-edge technology and experienced cardiologists.',
      color: 'bg-red-500',
      bgColor: 'bg-red-50',
      image: d7
    },
    {
      icon: Brain,
      title: 'Cardiology',
      description: 'Comprehensive brain and nervous system treatment with modern facilities.',
      color: 'bg-purple-500',
    ...
    },
    {
      icon: Bone,
      title: 'ENT',
      description: 'Expert bone, joint, and muscle care with advanced surgical techniques.',
      color: 'bg-green-500',
      bgColor: 'bg-green-50',
      image: d10
    },
      ...
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Our specialized medical centers provide world-class healthcare services with cutting-edge technology and expert medical professionals.
          </p>
        </motion.div>
