...
//   const handleDropdownItemClick = (item: any, dropdownItem: string) => {
...
const Header: React.FC<HeaderProps> = ({ onBookAppointment }) => {
  ...
  const routeMap: Record<string, string> = {
    ...
    "Outpatient Department Complex": "/facilities/outpatient",
